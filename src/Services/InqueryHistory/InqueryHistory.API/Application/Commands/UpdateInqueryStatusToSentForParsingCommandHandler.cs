namespace InqueryHistory.Commands
{
    ...
    public class UpdateInqueryStatusToSentForParsingCommandHandler
        : IRequestHandler<UpdateInqueryStatusToSentForParsingCommand, bool>
    {
        ...
        public UpdateInqueryStatusToSentForParsingCommandHandler(IMediator mediator, 
        ...
        public async Task<bool> Handle(UpdateInqueryStatusToSentForParsingCommand @command, CancellationToken cancellationToken)
        {
            ...
            inqueryHistoryToUpdate.SetSentForParsingStatus();
