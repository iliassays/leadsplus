namespace InvitationHistory
{
    using Autofac;
    using Autofac.Extensions.DependencyInjection;
    using InqueryHistory;
    using InqueryHistory.Infrastructure.AutofacModules;
    using InqueryHistory.Infrastructure.Filters;
    using InqueryHistory.IntegrationEvents;
    using InqueryHistory.Services;
    using InvitationHistory.Infrastructure.AutofacModules;
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        private void ConfigureEventBus(IApplicationBuilder app)
        {
            ...
            eventBus.Subscribe<EmailParsedIntegrationEvent, EmailParsedIntegrationEventHandler>();
            eventBus.Subscribe<NewInqueryRequestReceivedIntegrationEvent, NewInqueryRequestReceivedIntegrationEventHandler>();
        }
    ...
    static class CustomExtensionsMethods
    {
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Inquery Hisitory HTTP API",
                    Version = "v1",
                    Description = "The Inquery History Service HTTP API",
                ...
                options.AddSecurityDefinition("oauth2", new OAuth2Scheme
                {
                    ...
                    {
                        { "inqueryhistory", "Inquery History API" }
                    }
                });
        ...
        {
            services.AddOptions();
            services.Configure<InqueryHistorySettings>(configuration);
        ...
        public static IServiceCollection AddCustomAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            }).AddJwtBearer(options =>
            {
                ...
                options.Audience = "inqueryhistory";
