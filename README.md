# LeadsPlus - Microservices Architecture and Containers based Application powered by Microsoft .NET Core 2.1, based on a simplified microservices architecture and Docker containers.
